...
export default function WorkerFormRouter({ id, brandIcon = '📋', brandLabel = 'טפסים לעובדים סוציאליים', onBack, initialValues = null, onSubmitted = null }) {
  const t = useT();
  ...
  if (isStructuredForm(state.tmpl)) {
    return <StructuredFormView template={state.tmpl} brandIcon={brandIcon} brandLabel={brandLabel} onBack={onBack} initialValues={initialValues} onSubmitted={onSubmitted} />;
  }
