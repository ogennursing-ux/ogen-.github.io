...
export const STEPS = [
  ...
  { key: 'passport', type: 'file', category: 'passport', label: 'דרכון של העובד/ת',
    ask: 'תודה! שלחו לי **צילום** של **עמוד הפרטים בדרכון** של העובד/ת — מספיק תמונה (גם כזו שכבר שמורה לכם בטלפון), אין צורך בדרכון עצמו. שיראו בה את השם, מספר הדרכון ותאריך הלידה.' },
